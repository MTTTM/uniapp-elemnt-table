<template>
	<view>
		...
		<view >自定义列内容</view>
		<v-table :columns="columnsOperate" :list="dataOperate" v-on:delete="deleteFn"></v-table>
		<button  type="warn" @tap="alertFnCallback('删除 id:')">删除</button>
	</view>
...
<script>
	...
	export default {
		components:{vTable,vTableRow,vTableColumn},
		data() {
			return {
				 data:[
                    {
